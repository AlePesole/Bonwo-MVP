...
function PublicationExercisesTab() {
  ...
  const [editing, setEditing] = useState<ExercisePublicationResponse | null>(null);
  const [detail, setDetail] = useState<ExercisePublicationResponse | null>(null);

  const typeOptions: PublicationType[] = isAdmin
    ? ["COMMUNITY", "OFFICIAL"]
    : ["COMMUNITY"];
            ...
            <div className="text-center py-16 space-y-3">
              ...
              <p className="text-muted-foreground text-sm">
                {hasAnyFilter
                  ...
                  : "No publications yet. Publish your first exercise!"}
              </p>
              {!hasAnyFilter && (
...
export function PublicationExercisesPage() {
  return (
    <div className="max-w-5xl mx-auto">
      ...
      >
        <ChevronLeft className="h-4 w-4" /> Publications
      </Link>

      <div className="mb-6 text-center">
        <h1 className="text-3xl font-bold">Exercise Publications</h1>
      </div>

      <PublicationExercisesTab />
    </div>
  );
}
